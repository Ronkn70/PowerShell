...
## Configure Logging
#  Set log path
$ResultCSV = "$env:windir\Temp\Clean-CCMCache-$Date.log"
...
$CM_CacheItems = Get-WmiObject -Namespace root\ccm\SoftMgmtAgent -Query 'SELECT ContentID,Location FROM CacheInfoEx WHERE PersistInCache = Null'
